...
# Script pour démarrer Strapi et migrer l'équipe
# Usage: ./scripts/migrate-team-with-strapi.sh
...
# Lancer la migration de l'équipe
echo "📦 Migration des membres de l'équipe..."
