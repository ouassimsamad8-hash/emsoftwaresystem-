...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: { en: 'Explore emerging trends and technologies shaping the future of web development, from AI integration to edge computing.', fr: 'Explorez les tendances émergentes et les technologies qui façonnent l\'avenir du développement web, de l\'intégration IA au edge computing.' },
  ...
  },
  {
    ...
    excerpt: { en: 'Learn how to successfully navigate digital transformation in your organization with proven strategies and frameworks.', fr: 'Apprenez à naviguer avec succès dans la transformation digitale de votre organisation avec des stratégies et cadres éprouvés.' },
    content: { en: 'Full article content here...', fr: 'Contenu complet de l\'article ici...' },
    category: 'business',
  ...
  },
  {
    ...
    title: { en: 'Cloud Security Best Practices for 2025', fr: 'Meilleures Pratiques de Sécurité Cloud pour 2025' },
    excerpt: { en: 'Essential security measures and compliance strategies for protecting your cloud infrastructure in the modern era.', fr: 'Mesures de sécurité essentielles et stratégies de conformité pour protéger votre infrastructure cloud à l\'ère moderne.' },
    content: { en: 'Full article content here...', fr: 'Contenu complet de l\'article ici...' },
    category: 'security',
  ...
  },
  {
    ...
    title: { en: 'Mastering React Performance Optimization', fr: 'Maîtriser l\'Optimisation des Performances React' },
    excerpt: { en: 'Deep dive into advanced techniques for optimizing React applications, from code splitting to virtualization.', fr: 'Plongée approfondie dans les techniques avancées pour optimiser les applications React, du fractionnement de code à la virtualisation.' },
    content: { en: 'Full article content here...', fr: 'Contenu complet de l\'article ici...' },
    category: 'development',
    categoryLabel: { en: 'Development', fr: 'Développement' },
    image: 'Web_app_dashboard_d564f681.png',
    author: 'David Park',
  ...
  },
  {
    ...
    title: { en: 'How AI is Revolutionizing Software Development', fr: 'Comment l\'IA Révolutionne le Développement Logiciel' },
    excerpt: { en: 'Discover how artificial intelligence and machine learning are transforming the way we build software.', fr: 'Découvrez comment l\'intelligence artificielle et l\'apprentissage automatique transforment la façon dont nous construisons des logiciels.' },
    content: { en: 'Full article content here...', fr: 'Contenu complet de l\'article ici...' },
    category: 'technology',
    categoryLabel: { en: 'Technology', fr: 'Technologie' },
    image: 'Enterprise_software_dashboard_9e058f15.png',
  ...
  },
  {
    ...
    title: { en: 'Building Scalable Applications with Microservices', fr: 'Construire des Applications Évolutives avec les Microservices' },
    excerpt: { en: 'A comprehensive guide to designing and implementing microservices architecture for enterprise applications.', fr: 'Un guide complet pour concevoir et implémenter une architecture de microservices pour les applications d\'entreprise.' },
    content: { en: 'Full article content here...', fr: 'Contenu complet de l\'article ici...' },
    category: 'development',
    categoryLabel: { en: 'Development', fr: 'Développement' },
    image: 'Cloud_platform_dashboard_86d0bb3f.png',
  ...
  },
  {
    ...
    title: { en: '2025 Mobile App Development Trends', fr: 'Tendances du Développement d\'Applications Mobiles 2025' },
    excerpt: { en: 'Stay ahead of the curve with the latest mobile app development trends, from 5G to AR/VR integration.', fr: 'Gardez une longueur d\'avance avec les dernières tendances du développement d\'applications mobiles, de la 5G à l\'intégration AR/VR.' },
    content: { en: 'Full article content here...', fr: 'Contenu complet de l\'article ici...' },
    category: 'technology',
    categoryLabel: { en: 'Technology', fr: 'Technologie' },
    image: 'Mobile_app_mockup_b758143d.png',
  ...
  },
  {
    ...
    title: { en: 'Essential Cybersecurity Checklist for Startups', fr: 'Liste de Contrôle de Cybersécurité Essentielle pour les Startups' },
    excerpt: { en: 'Protect your startup from cyber threats with this comprehensive security checklist and best practices guide.', fr: 'Protégez votre startup contre les cybermenaces avec cette liste de contrôle de sécurité complète et ce guide des meilleures pratiques.' },
    content: { en: 'Full article content here...', fr: 'Contenu complet de l\'article ici...' },
    category: 'security',
    categoryLabel: { en: 'Security', fr: 'Sécurité' },
    image: 'Project_management_software_c23ed5e4.png',
  ...
  },
  {
    ...
    title: { en: 'Agile vs Waterfall: Choosing the Right Methodology', fr: 'Agile vs Waterfall : Choisir la Bonne Méthodologie' },
    excerpt: { en: 'Compare agile and waterfall methodologies to find the best approach for your software development projects.', fr: 'Comparez les méthodologies agile et waterfall pour trouver la meilleure approche pour vos projets de développement logiciel.' },
    content: { en: 'Full article content here...', fr: 'Contenu complet de l\'article ici...' },
    category: 'business',
    categoryLabel: { en: 'Business', fr: 'Affaires' },
    image: 'Ecommerce_platform_interface_1b61c289.png',
